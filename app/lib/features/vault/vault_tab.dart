  ...
  Widget _buildSidebarList() {
    return ListView(
      ...
      children: [
        ...
        _buildSidebarTile('ssh_key', 'SSH Keys', Icons.terminal_outlined),
        _buildSidebarTile('api_key', 'API Keys & Tokens', Icons.api_outlined),
        _buildSidebarTile('crypto_seed', 'Crypto Seeds', Icons.currency_bitcoin),
        _buildSidebarTile('software_license', 'Software Licenses', Icons.card_membership_outlined),
        const Divider(color: Colors.white10),
